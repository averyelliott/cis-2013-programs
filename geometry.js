...
//calculates circles area using a function
...
//calculate Triangle area using a function
var calcTriangleArea = function()
{
    ...
    alert ("The Triangles area is "+ triangleArea(floatTriSide1,floatTriSide2,floatTriSide3));
};

function triangleArea(side1,side2,side3)
{
    var floatS = (side1 + side2 + side3)/2;
    var floatTriangleArea = parseFloat(Math.sqrt((floatS*(floatS-side1)*(floatS-side2)*(floatS-side3))));
    return floatTriangleArea.toFixed(2);
}

//calculate Triangles perimeter using a function
var calcTrianglePerim = function()
{
    ...
    alert ("The Triangles perimeter is "+ trianglePerim(floatTriSide1,floatTriSide2,floatTriSide3));
};

function trianglePerim(side1,side2,side3)
{
    var floatTrianglePerim = parseFloat(side1 + side2 + side3);
    return floatTrianglePerim.toFixed(2);
}

//calculates Rectangles area 
var calcRectArea = function()
{
    var floatRectWidth = parseFloat($("rect_width").value);
	var floatRectHeight = parseFloat($("rect_height").value);
    
    alert ("The Rectangles area is " + rectArea(floatRectWidth,floatRectHeight));
};

function rectArea(width,height)
{
    var floatRectangleArea = parseFloat(width*height);
...
var calcRectPerim = function()
{
    ...
    alert ("The Rectangles perimeter is " + rectPerim(floatRectWidth,floatRectHeight));
};

function rectPerim(width,height)
{
    var floatRectanglePerim = parseFloat(2*width + 2*height);
